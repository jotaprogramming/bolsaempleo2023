...
class PublicateView(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["app_title"] = offer_view
        context["title_view"] = publish_view
        return context


class OffersView(generic.TemplateView):
    profile_url = "/offers"
    template_name = "offers.html"

    def get_context_data(self, **kwargs):
        context = super(OffersView, self).get_context_data(**kwargs)
        context["app_title"] = offer_title
        context["title_view"] = offer_view
        return context
...
class OfferDetailView(generic.TemplateView):
    profile_url = "/offer_detail"
    template_name = "offer_desc.html"

    def get_context_data(self, **kwargs):
        context = super(OfferDetailView, self).get_context_data(**kwargs)
        context["app_title"] = offer_view
        context["title_view"] = offer_desc
        return context
